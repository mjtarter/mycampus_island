                ...
                <div class="col-xs-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 text-center" id="contact-overlay-box">
                    ...
                    <form name="contactform" method="post" class="form-horizontal" action="send_form_email.php">
                        ...
                        <div class="form-group" style="width:80%; margin-right:auto; margin-left:auto">
                            ...
                            <textarea class="form-control" id="comments" name="comments" rows="5">Hello! I was searching for student housing on MyCampusIsland.com and found information about <script>document.write(name);</script>. Please respond at your earliest convenience to discuss availability. Thank you!"</textarea>
                        </div>
                        <div class="form-group">

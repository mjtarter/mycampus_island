...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
    	...
    	<title><?php echo $field_db['Name'] . ' Dorm | Bloomington | Student Housing' ;?></title> 
	...
	<body id="dorm-page" onLoad="imgOne(); setTimeout('imgOne2()', 3000); setTimeout('imgOne3()', 6000); setTimeout('imgOne4()', 9000); setTimeout('imgOne5()', 12000);" id="property-page"/>	
...
<?php
	...
	if (file_exists('photos/dorms/' . $field_db['Name'] .'-6.jpg')) {
		include ('inc/multi-image-display-dorm.php') 
	;} else {
		 echo 
		'<div id="top-container">
			<img src="photos/' . $field_db['Name'] .'-1.jpg" id="main-photo">';}
?> 
			
			<div class="info-overlay">
				<div class="container" id="overlay-tbl">
					<div class="col-xs-8 col-md-6 col-lg-5 col-lg-offset-1 overlay-text">
						<span class="glyphicon glyphicon-map-marker pad-hor-5" aria-hidden="true"></span> <?php echo $field_db['Name']; ?><span class="hidden-xs"> Dorm, Bloomington, IN</span>
						<br><span class="glyphicon glyphicon-home pad-hor-5" aria-hidden="true"></span> Neighborhood: <?php echo $field_db['location']; ?>
					</div>
					<div class="col-md-4 col-lg-3 text-right hidden-sm hidden-xs overlay-text">
						<p class="no-margin">
							<?php  if ($field_db['address'] !== "") {
								echo  $field_db['address'] . '<br>';
							} echo $field_db['phone'];?> 
						</p>
					</div>					
					<div class="col-xs-4 col-md-2 col-lg-offset-1 text-right overlay-btn">
						<a href="#textModal" data-toggle="modal" class="button blue-button">Contact Us!</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-sm-6" id="at-a-glance">
					...
					<ul id="basic-info" class="col-lg-10 col-lg-offset-1 clearfix">
						...
						<li>Floors:</li>
						<li><?php echo $field_db['floors'];?></li>
						<li>Beds:</li>
						<li><?php echo $field_db['beds']; ?></li>
						<li>Rooms:</li>
						<li><?php echo $field_db['rooms']; ?></li>
						<li>Bathrooms:</li>
						<li><?php echo $field_db['bathrooms']; ?></li>
						<li>Gender on Floor:</li>
						<li><?php echo $field_db['gender_on_floor']; ?></li>
						<li>Price:</li>
						<li><?php echo $field_db['price']; ?></li>		
						<li>Parking Zone:</li>
						<li><?php echo $field_db['parking_zone']; ?></li>																
					</ul>
				</div>
